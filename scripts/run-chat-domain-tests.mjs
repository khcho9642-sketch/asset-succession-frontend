...
const result = spawnSync(process.execPath, ["--test", path.join(outDir, "scripts", "chat-domain-tests.js"), ...["server", "guide", "response", "choices", "guided", "agent", "fallback", "tax-grounding"].map(name => path.join(outDir, "lib", "chat", `${name}.test.js`))], { cwd: outDir, stdio: "inherit" });
