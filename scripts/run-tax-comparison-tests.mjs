...
const tests = ["scripts/tax-inheritance-gift-tests.ts", "scripts/tax-capital-business-tests.ts", "scripts/tax-comparison-tests.ts", "scripts/tax-housing-tests.ts", "scripts/tax-business-inheritance-tests.ts"];
