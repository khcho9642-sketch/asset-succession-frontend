...
const seededAssessment = {
  ...
  conversation: {
    ...
    confirmed_facts: [],
    raw_inputs: ["본인 자산, 총자산 50억원, 금융자산 30억원, 아파트 20억원, 채무 없음, 배우자 1명, 성인 자녀 2명, 3년 전 자녀별 1억원 증여 및 신고, 목표: 세금 부담 절감과 노후생활비 유지, 자녀에게 5억원 대출 검토, 첫째는 상환능력 있음, 둘째는 상환능력 부족, 보험 없음, 상속세 납부 가능 현금 3억원", "없어요, 분석해 주세요"]
  }
};
