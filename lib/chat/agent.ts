...
export const diagnosisTurnSchema = proposeFactsInputSchema.extend(diagnosisReplySchema.shape).strict();
...
고객용 응답의 전달 형식:
최종 응답은 제공된 JSON 스키마에 맞춰 facts, message, choices를 한 번에 작성합니다.
