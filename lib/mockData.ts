...
export const wizardSteps: WizardStep[] = [
  ...
  },
  {
    ...
    helper: "정확한 실명 대신 관계, 배우자 유무, 자녀 수만으로 사전진단을 시작할 수 있습니다. 성년 여부를 모르면 미상으로 남겨도 됩니다.",
  ...
  },
  {
    ...
    choices: ["부동산", "금융자산", "법인지분", "보험", "기타", "잘 모르겠음"],
  ...
  },
  {
    ...
    helper: "부담부증여와 10년 합산 검토가 필요한지 판단하는 단계입니다. 불확실한 ‘없는 것 같음’은 채무 0원으로 확정하지 않습니다.",
  ...
  },
  {
    ...
    helper: "절세만이 아니라 통제권, 유동성, 가족 간 형평을 함께 비교합니다. 최대 3개까지 고르면 그대로 보존합니다.",
    primaryQuestion: "우선순위에 가까운 목표를 선택해 주세요.",
    choices: ["세금 부담 절감", "노후생활비 유지", "일부를 미리 이전", "상속세 납부재원 준비", "현재 구조 유지", "자산을 매각해 현금화", "가족법인 활용", "아직 모르겠음"],
